...
public class LocationsAPILoader extends AsyncTaskLoader<LocationsAPILoader.RESTResponse> {
    private static final String TAG = LocationsAPILoader.class.getName();
    ...
    private String jsonReqStr = "{\"protocolVersion\" : \"1\", \"schemaVersion\" : \"1.3.0\", \"requestType\" : \"get\", \"requestData\" : { \"location\" : [{ \"name\":null }]}}";
    
    private long mLastLoad;
    
    public LocationsAPILoader(Context context, Settings settings) {
        super(context);
        mVerb = HTTPVerb.POST;
        ...
        //mClusterName="ec2-23-20-243-84.compute-1.amazonaws.com";
        //mUserName = "admin";
        //mPassword = "redwood";
        
        //mAction = Uri.parse("http://"+mClusterName+"/uApi");
        mAction = Uri.parse("https://"+mClusterName+"/uApi");
        
        
    }
    
    public LocationsAPILoader(Context context, HTTPVerb verb, Uri action) {
        super(context);
    ...
    public LocationsAPILoader(Context context, HTTPVerb verb, Uri action, Bundle params) {
        super(context);
